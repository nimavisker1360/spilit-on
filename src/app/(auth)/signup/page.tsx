        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            ...
            {fields.map((f) => (
              <div key={f.id}>
                ...
                <input
                  ...
                  style={{ ...inputStyle, borderColor: focused === f.id ? authAccent.focus : "#252b38" }}
                />
              </div>
            ))}
            ...
            <button
              type="submit"
              disabled={loading}
              style={{ marginTop: "4px", width: "100%", backgroundColor: authAccent.base, color: "#fff", border: "none", borderRadius: "10px", padding: "12px", fontSize: "14px", fontWeight: 700, cursor: loading ? "not-allowed" : "pointer", opacity: loading ? 0.65 : 1, minHeight: "unset", transition: "background-color 150ms ease" }}
          ...
          <p style={{ marginTop: "20px", textAlign: "center", fontSize: "13px", color: "#94a3b8" }}>
            ...
            <Link href="/login" style={{ fontWeight: 600, color: authAccent.base }}>
              Giriş yapın
            </Link>
          </p>
